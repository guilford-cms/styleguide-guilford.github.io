...
/** edited 168-174 line don't update plugin  **/
    ...
    DOM.extend("input[type=date]", {
        constructor: function () {
            ...
            // IE8 doesn't suport color:transparent - use background-color instead
                ...
                .on("keydown", ["which"], this._keydownPicker.bind(this, picker)).before(picker.hide(), label).closest("form")
                .on("reset", this._syncValue.bind(this, "defaultValue", label));
        ...
        _syncValue: function (propName, label) {
            ...
            if (!isNaN(date)) {
                ...
                if(editDate) {
                    ...
                    if(propName !== 'defaultValue' && typeof Drupal === 'object') {
                        Drupal.behaviors.calendarFilters.date(formattedDate);
                    }
                }
            } else {
                label.set("datetime", "");
